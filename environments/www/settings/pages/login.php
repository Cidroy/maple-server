...
<html lang="en">
	<head>
		...
		<title>Login - Maple Website Control Panel</title>
			...
			<div class="row">
				<div class=" col-sm-12 col-lg-6 col-lg-offset-3">
					<div class="panel panel-primary">
						<div class="panel-heading text-center">Maple Website Control Panel</div>
						<div class="panel-body">
							<form action="" method="post">
								...
								<br>
								<input type="text" name="www-ajax-action" value="login" hidden="true">
