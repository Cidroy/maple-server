...
<?php
	$active 	= \maple\www\WWW::sites("active");
	$all		= \maple\www\WWW::sites("*");
	...
	<div class="col-sm-12">
			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo \maple\environments\eWWW::url("root").$data["url"] ?></td>
		...
		<?php else:?>
			<div class="callout callout-warning">
				...
				<p>It seems that you do not have an active website.Please create a new configuration or add a packages folder that supports maple environment namespace "maple/www"</p>
			</div>
		<?php endif;?>
	</div>
	<div class="col-sm-12">
