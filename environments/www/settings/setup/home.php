...
<html lang="en">
	<head>
		...
		<title>Setup - Maple Website</title>
	...
	<body>
		<div class="container">
			<h1 class="text-success text-center">Welcome to Maple Website!</h1>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<form action="" method="post">
							...
							<br>
							<input type="text" name="www-ajax-action" value="install" hidden="true">
				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<p>
							...
							This is the url that you need to enter in order to access the Maple Website Control Panel.<br>
