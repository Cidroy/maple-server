...
class Medoo
{
	...
	public function select($table, $join, $columns = null, $where = null)
	{
		...
		$query = $this->do_query($this->selectContext($table, $join, $columns, $where));
	...
	public function get($table, $join = null, $columns = null, $where = null)
	{
		...
		$query = $this->do_query($this->selectContext($table, $join, $columns, $where) . ' LIMIT 1');
	...
	public function has($table, $join, $where = null)
	{
		...
		$query = $this->do_query('SELECT EXISTS(' . $this->selectContext($table, $join, $column, $where, 1) . ')');
	...
	{
		$query = $this->do_query($this->selectContext($table, $join, $column, $where, 'COUNT'));
	...
	{
		$query = $this->do_query($this->selectContext($table, $join, $column, $where, 'MAX'));
	...
	{
		$query = $this->do_query($this->selectContext($table, $join, $column, $where, 'MIN'));
	...
	{
		$query = $this->do_query($this->selectContext($table, $join, $column, $where, 'AVG'));
	...
	{
		$query = $this->do_query($this->selectContext($table, $join, $column, $where, 'SUM'));
