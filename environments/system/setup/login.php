...
<html lang="en">
	<head>
		...
		<title>Login - Maple Environment Control Panel</title>
	...
	<body>
		...
		<div class="container">
			...
			<div class="row">
				<div class="panel panel-primary col-sm-12 col-lg-6 col-lg-offset-3">
					<div class="panel-heading text-center">Maple Environment Control Panel</div>
					<div class="panel-body">
						<form action="" method="post">
							...
							<br>
							<input type="text" name="environment-ajax-action" value="login" hidden="true">
